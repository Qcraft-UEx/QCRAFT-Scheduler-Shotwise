...
circuit.h(qreg_q[3])
circuit.h(qreg_q[4])
circuit.cp(np.pi / 512, qreg_q[4], qreg_q[5])
circuit.cp(np.pi / 256, qreg_q[3], qreg_q[5])
circuit.cp(np.pi / 128, qreg_q[2], qreg_q[5])
circuit.cp(np.pi / 64, qreg_q[1], qreg_q[5])
