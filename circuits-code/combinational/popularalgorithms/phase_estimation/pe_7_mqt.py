...
circuit.h(qreg_q[5])
circuit.x(qreg_q[6])
circuit.cp(-7 * np.pi / 8, qreg_q[6], qreg_q[0])
circuit.swap(qreg_q[0], qreg_q[5])
circuit.h(qreg_q[0])
circuit.cp(np.pi / 4, qreg_q[6], qreg_q[1])
circuit.swap(qreg_q[1], qreg_q[4])
circuit.cp(-np.pi / 2, qreg_q[1], qreg_q[0])
circuit.h(qreg_q[1])
circuit.cp(np.pi / 2, qreg_q[6], qreg_q[2])
circuit.cp(np.pi, qreg_q[6], qreg_q[3])
...
circuit.h(qreg_q[4])
circuit.cp(-np.pi / 32, qreg_q[5], qreg_q[0])
circuit.cp(-np.pi / 16, qreg_q[5], qreg_q[1])
circuit.cp(-np.pi / 8, qreg_q[5], qreg_q[2])
circuit.cp(-np.pi / 4, qreg_q[5], qreg_q[3])
circuit.cp(-np.pi / 2, qreg_q[5], qreg_q[4])
circuit.h(qreg_q[5])
